...
def load_data(dataset_str: str = 'cora', sparse: bool = False):
    ...
    for i in range(len(names)):
        with open("/home/jungang/dataset/cora/ind.{}.{}".format(dataset_str, names[i]), 'rb') as f:
    ...
    test_idx_reorder = parse_index_file("/home/jungang/dataset/cora/ind.{}.test.index".format(dataset_str))
