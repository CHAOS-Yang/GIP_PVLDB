...
class BlockV1(hk.Module):
  ...
  def __init__(
    ...
    if self.use_projection:
      self.proj_conv = common.WSConv2D(
...
class ResNet(hk.Module):
  ...
  def __init__(
    ...
    if not self.resnet_v2:
      self.initial_batchnorm = self.norm_fn(name="initial_batchnorm")
    ...
    if self.resnet_v2:
      self.final_batchnorm = self.norm_fn(name="final_batchnorm")
