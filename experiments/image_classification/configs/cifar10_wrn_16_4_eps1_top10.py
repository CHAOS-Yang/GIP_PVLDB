...
"""Training a WRN-16-4 on CIFAR-10 with (1.0, 1e-5)-DP with GIP method."""
...
def get_config(config):
  """Experiment config."""
  config.checkpoint_dir = '../../result/eps=1/top10'  
  config.experiment_kwargs = configdict.ConfigDict(
      dict(
          config=dict(
              num_updates=875,  ##
              checkpoint_dir = '../../result/eps=1/top10',
